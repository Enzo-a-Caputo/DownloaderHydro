...
Migrado de `delineator-main/py/raster_plots.py` (Matthew Heberger,
mghydro.com/watersheds) sem modificações funcionais — apenas movido para o
pacote do webapp para eliminar o sys.path injection. Funções aqui só são
chamadas se `plots=True` for passado para `merit_detailed.split_catchment`.
"""
